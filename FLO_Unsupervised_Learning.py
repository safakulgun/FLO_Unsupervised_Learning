...
# GÖREV 1: Veriyi Hazırlama
           # 1. flo_data_20K.csv.csv verisini okutalım.
           # 2. Müşterileri segmentlerken kullanacağınız değişkenleri seçelim. Tenure(Müşterinin yaşı), Recency (en son kaç gün önce alışveriş yaptığı) gibi yeni değişkenler oluşturalım.

# GÖREV 2: K-Means ile Müşteri Segmentasyonu
           # 1. Değişkenleri standartlaştıralım.
           # 2. Optimum küme sayısını belirleyelim.
           # 3. Modelimizi oluşturaralım ve müşterilerimizi segmentleyelim.
           # 4. Herbir segmenti istatistiksel olarak inceleyelim.

# GÖREV 3: Hierarchical Clustering ile Müşteri Segmentasyonu
           # 1. Görev 2'de standırlaştırdığımız dataframe'i kullanarak optimum küme sayısını belirleyelim.
           # 2. Modelimizi oluşturalım ve müşterilerimizi segmentleyelim.
           # 3. Herbir segmenti istatistiksel olarak inceleyelim.


###############################################################
# GÖREV 1: Veri setini okutalım ve müşterileri segmentlerken kullanıcağınız değişkenleri seçelim.
###############################################################
...
df_ = pd.read_csv("C:/Users/sfkul/Downloads/FLO_Unsupervised_Learning-221212-014944 (1)/FLO_Unsupervised_Learning/flo_data_20k.csv")
df = df_.copy()
